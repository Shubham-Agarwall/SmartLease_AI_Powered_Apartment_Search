...
def crop_screenshot(screenshot_path, cropped_path):
    """
    Crop the screenshot to focus on the central part of the image.
...
def open_images_in_browser(input_csv, output_csv, output_folder, user_agent):
    """
    Open image URLs in Chrome using Selenium, save cropped screenshots, 
    and update the CSV with the image folder paths.
    
    Args:
        input_csv (str): Path to the input CSV file.
        output_csv (str): Path to save the updated CSV file.
        output_folder (str): Folder where cropped screenshots will be saved.
        user_agent (str): User agent to use for the browser.
    """
    # Read the input CSV
